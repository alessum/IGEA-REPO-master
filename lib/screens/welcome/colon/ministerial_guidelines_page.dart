...
class MinisterialGuidelinesPage extends StatelessWidget {
  const MinisterialGuidelinesPage({
    Key key,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              'Secondo le linee guida ministeriali e secondo i dati che hai inserito dovresti fare un esame del sangue occulto nelle feci (SOF) ogni',
              style: TextStyle(
