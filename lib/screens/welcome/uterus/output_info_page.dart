...
class OutputInfoPage extends StatefulWidget {
  OutputInfoPage({
    Key key,
    @required this.flashToPage,
  }) : super(key: key);

  final Function(int page) flashToPage; //per tornare alla home questionari

  @override
  _OutputInfoPageState createState() => _OutputInfoPageState();
}

class _OutputInfoPageState extends State<OutputInfoPage> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              'Secondo le linee guida ministeriali e secondo i dati che hai inserito dovresti fare un pap-test ogni',
              style: TextStyle(
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  //           'Come viene calcolata la frequenza con cui fare l\'esame');
                  //     },
                  //     child: Container(
                  //       height: media.height * 0.05,
          ...
          Container(
            padding: EdgeInsets.symmetric(horizontal: 35),
            child: Text(
              'Hai mai fatto un pap-test o un hpv DNA test?',
              style: TextStyle(
                  fontSize: media.width * 0.05,
                  color: Colors.white,
                  fontFamily: 'Bold'),
