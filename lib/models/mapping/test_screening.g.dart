...
// part of '../test_screening.dart';

// // **************************************************************************
// // JsonSerializableGenerator
// // **************************************************************************

// ScreeningTest _$ScreeningTestFromJson(Map<dynamic, dynamic> json) {
...
//         ? null
//         : OutcomeScreening.fromJson(
//             json['outcome'] as Map<dynamic, dynamic>);
//     // ..hasOutcome = json['has_outcome'] as bool;
// }

// Map<String, dynamic> _$ScreeningTestToJson(ScreeningTest instance) =>
//     <String, dynamic>{
//       'name': instance.name,
